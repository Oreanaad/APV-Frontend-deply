...
const EditarPerfil = () => {
  ...
  return (
   <>
   <AdminNav/>
   <h2 className="font-black text-xl text-center mt-10">Edita tu perfil</h2>
    ...
    <div className="flex justify-center">
        ...
        {msg && <Alerta alerta= {alerta}/>}
          ...
          >
              ...
              className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full hover:cursor-pointer"
              >
              </input>
